...
def advertising_reach(tg_slug: str) -> Response:
    """
    ...
    headers = {
       ...
       'accept-language': 'ru-RU,ru;q=0.9,en-US;q=0.8,en;q=0.7',
        ...
        'newrelic': 'eyJ2IjpbMCwxXSwiZCI6eyJ0eSI6IkJyb3dzZXIiLCJhYyI6IjM0NTMyNzEiLCJhcCI6IjMyODAxMDQxNyIsImlkIjoiMzZhYjdjYTkxNWFhMWEyMiIsInRyIjoiMzA5NzdhYjUyYTkzNTgwNDc1MTgwN2VmMzRhOGFlMjAiLCJ0aSI6MTY3ODc5MjY5MjcxNH19',
        ...
        'traceparent': '00-30977ab52a935804751807ef34a8ae20-36ab7ca915aa1a22-01',
        'tracestate': '3453271@nr=0-1-3453271-328010417-36ab7ca915aa1a22----1678792692714',
    ...
    response = requests.post(
        f'https://tgstat.ru/channel/@{tg_slug}/stat/posts-views-adv-chart',
        cookies=cookies,
        headers=headers,
        data=data,
    )
...
if __name__ == '__main__':
    pprint(advertising_reach('nashturist'))
